	...
	function teamColor(Team)
		if (Team == TEAM_RED)	then
			_GModRect_SetColor( 255, 192, 192, 150 );
		elseif (Team == TEAM_BLUE) then
			_GModRect_SetColor( 192, 192, 255, 150 );
		elseif (Team == TEAM_GREEN) then
			_GModRect_SetColor( 192, 255, 192, 150 );
		elseif (Team == TEAM_YELLOW) then
			_GModRect_SetColor( 255, 255, 192, 150 );
		else
			_GModRect_SetColor( 192, 192, 192, 150 );
		end
	end
	...
	function onShowTeam ( userid )
		...
		_GModText_Start( "ImpactMassive" ); -- Title
		...
		_GModText_Start( "HudHintTextLarge" ); -- credit line
		...
		_GModRect_Start( "gmod/white" ); -- background
		...
		_GModText_Start("Default"); -- Options
